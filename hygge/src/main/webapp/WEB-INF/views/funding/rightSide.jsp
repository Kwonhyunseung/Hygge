...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/dist/css/funding/main/rightSide.css"
	type="text/css">
		...
		<div class="maker-info">
			...
			<div class="row">
				<div class="col-2 maker-profile">
					<img
						src="${pageContext.request.contextPath}/dist/images/funding/right/profile.png">
				</div>
			...
			<div class="maker-btn">
				...
				<button type="button" class="followBtn" onclick="makerFollow()">
					<i class="bi bi-suit-heart"></i> 메이커 팔로우
				</button>
			</div>
		</div>
