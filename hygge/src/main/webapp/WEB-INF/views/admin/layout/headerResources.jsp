...
<link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/admin/base.css" type="text/css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/admin/header.css" type="text/css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/admin/sidebar.css" type="text/css">
